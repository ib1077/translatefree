...
const CACHE=PREFIX+'287b40a561119438';
const ASSETS=["./", "./index.html", "./styles.css", "./app.js", "./data.js", "./register.js", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png"];
